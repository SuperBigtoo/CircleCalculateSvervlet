...
public class CircleServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String input = request.getParameter("radius");
        ...
        if ("Area".equals(action)) {
            actionText = "Area is ";
            actionResult = Math.PI * radius * radius;
        } else if ("Perimeter".equals(action)) {
            actionText = "Perimeter is ";
            actionResult = Math.PI * radius * 2;
        }
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>"+ actionText + actionResult + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
